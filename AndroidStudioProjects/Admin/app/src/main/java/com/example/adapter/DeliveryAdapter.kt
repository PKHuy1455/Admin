...
import com.example.fastfoodapp.databinding.DeliveryItemBinding
    ...
    inner class DeliveryViewHolder(private val binding: DeliveryItemBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int) {
               binding.apply {
                   ...
                   moneyStatusTxTView.text = moneyStatus[position]
                   val colorMap = mapOf(
                       "Received" to Color.GREEN,
                       "Not Received" to Color.RED,
                       "Pending" to Color.GRAY
                   )
                   moneyStatusTxTView.setTextColor(colorMap[moneyStatus[position]]?:Color.BLACK)
